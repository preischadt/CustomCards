...
function c420000052.spfilter1(c, tp)
	return c:IsCode(28297833) and c:IsAbleToRemoveAsCost() and c:IsCanBeFusionMaterial(nil, true) and
		Duel.IsExistingMatchingCard(c420000052.spfilter2, tp, LOCATION_GRAVE, 0, 1, c)
end
function c420000052.spfilter2(c)
	return (c:IsRace(RACE_ZOMBIE) or c:IsAttribute(ATTRIBUTE_DARK)) and c:IsCanBeFusionMaterial() and
...
function c420000052.sprcon(e, c)
	...
	return Duel.GetLocationCountFromEx(tp, tp, c) > 0 and
		Duel.IsExistingMatchingCard(c420000052.spfilter1, tp, LOCATION_GRAVE, 0, 1, nil, tp)
end
